This reposition contains code and data for NeurIPS 2023 Datasets and Benchmarks submission: [Revisiting Out-of-distribution Robustness in NLP: Benchmarks, Analysis, and LLMs Evaluations]()
